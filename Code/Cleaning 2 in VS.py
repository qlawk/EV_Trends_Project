...
df_history = pd.read_csv("C:\\Users\\17789\\LHL\\EV charging in Washington state\\data\\Electric_Vehicle_Population_Size_History_By_County.csv")
...
df_history.to_csv("C:\\Users\\17789\\LHL\\EV charging in Washington state\\data\\Cleaned_data\\ev_county_clean_final.csv", index=False)
df_population.to_csv("C:\\Users\\17789\\LHL\\EV charging in Washington state\\data\\Cleaned_data\\ev_pop_clean_final.csv", index=False)
df_stations.to_csv("C:\\Users\\17789\\LHL\\EV charging in Washington state\\data\\Cleaned_data\\wa_median_income.csv", index=False)


# Unify column names

df_data_1 = pd.read_csv("C:\\Users\\17789\\LHL\\EV charging in Washington state\\data\\Electric_Vehicle_Population_Size_History_By_County.csv")
df_data_2 = pd.read_csv("C:\\Users\\17789\\LHL\\EV charging in Washington state\\data\\Electric_Vehicle_Population_Data.csv")
df_data_3 = pd.read_csv("C:\\Users\\17789\\LHL\\EV charging in Washington state\\data\\wa_median_income.csv")

df_data_1['County'] = df_data_1['County'].apply(lambda x: x if x == 'Washington' else x + ' County')
df_data_2['County'] = df_data_2['County'].apply(lambda x: x if x == 'Washington' else x + ' County')
df_data_3['County'] = df_data_3['County'].apply(lambda x: x if x == 'Washington' else x + ' County')

df_data_1.to_csv("C:\\Users\\17789\\LHL\\EV charging in Washington state\\data\\Cleaned_data\\ev_county_clean_final.csv", index=False)
df_data_2.to_csv("C:\\Users\\17789\\LHL\\EV charging in Washington state\\data\\Cleaned_data\\ev_pop_clean_final.csv", index=False)
df_data_3.to_csv("C:\\Users\\17789\\LHL\\EV charging in Washington state\\data\\Cleaned_data\\wa_median_income.csv", index=False)
